...
7. If Accessibility score is not 100, identify all flagged accessibility issues from the Lighthouse report and fix them. Common issues:
...
8. Verify OG metadata by checking the built HTML output:
   ```bash
